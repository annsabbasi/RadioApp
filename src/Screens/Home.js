...
export default function Test({ navigation }) {
    ...
    const sidebarData = [
        ...
        { icon: require('../assets/icons/folder.png'), text: 'Archives', Screen: 'Archeives' },
        { icon: require('../assets/icons/comment.png'), text: 'About Us', Screen: 'Sponsers' },
                                    ...
                                    <View style={{ gap: 20, }}>
                                        {sidebarData.map((e, index) => (
                                            <TouchableOpacity key={index} style={styles.sidebarItems}
                                                // onPress={() => {
                                                //     sidebarClose;
                                                //     handleNavigate(e.pageChange)
                                                // }}
                                                onPress={() => handleNavigate(e.Screen)}
                                            >
