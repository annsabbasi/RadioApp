...
export default function Home({ navigation }) {
    ...
    const sidebarData = [
        { icon: require('../assets/icons/house.png'), text: 'Home', Screen: 'Home' },
        { icon: require('../assets/icons/user.png'), text: 'Profile', Screen: 'Profile' },
        { icon: require('../assets/icons/photo-camera.png'), text: 'Live Radio', Screen: 'LiveRadio' },
        { icon: require('../assets/icons/ticket.png'), text: 'Upcoming Shows', Screen: 'UpComing' },
        { icon: require('../assets/icons/headphones.png'), text: 'Dj Profile', Screen: 'DjProfile' },
        { icon: require('../assets/icons/folder.png'), text: 'Archeives', Screen: 'Archeives' },
        { icon: require('../assets/icons/comment.png'), text: 'About Us', Screen: 'ShowsContact' },
        { icon: require('../assets/icons/turn-off.png'), text: 'Logout', Screen: 'SignIn' },
        { icon: require('../assets/icons/headphones.png'), text: 'Sponsers', Screen: 'Sponsers' },
        { icon: require('../assets/icons/folder.png'), text: 'Archeive Inner', Screen: 'ArcheiveInner' },
        { icon: require('../assets/icons/comment.png'), text: 'Shows', Screen: 'Shows' },
    ]
